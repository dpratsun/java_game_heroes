...
public class AttackBySpellAction implements EnemyAction {
    private final String MESSAGE_TMPL = "%s attacking %s with magic. %s health is %shp";
    private final String MESSAGE_ACTION_ENHANCED = "%s magic attack damage enhanced to %s";
    private final LoggerManager logger = SingletonLoggerManager.getInstance();
    private final int damage;

    public AttackBySpellAction(int damage) {
        this.damage = damage;
    }
